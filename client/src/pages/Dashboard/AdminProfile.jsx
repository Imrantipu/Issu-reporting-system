  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-slate-600">Manage your administrative account</p>
      </div>
      ...
      <div className="glass-panel overflow-hidden rounded-3xl border border-slate-100/70 bg-white/85 shadow-xl shadow-cyan-200/40">
        <div className="h-24 bg-gradient-to-r from-rose-500 to-purple-500" />
          ...
          <div className="absolute -top-12 flex items-end gap-4">
            ...
            <div className="mb-2">
              <div className="flex items-center gap-2">
                <h2 className="text-2xl font-bold text-slate-900">{dbUser?.name || user?.displayName || 'Admin'}</h2>
                <span className="inline-flex items-center gap-1 rounded-full bg-rose-500 px-3 py-1 text-xs font-semibold text-white shadow-lg">
